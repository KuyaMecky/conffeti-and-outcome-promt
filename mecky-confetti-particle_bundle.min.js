/*! For license information please see tsparticles.confetti.bundle.min.js.LICENSE.txt */ ! function (t, e) {
    ...
    function Qt(t) {
        const {
            ...
            shadow: h,
            transform: d
        } = t, u = s.getPosition(), p = s.rotation + (s.pathRotation ? s.velocity.angle : 0), f = Math.sin(p), m = Math.cos(p), v = {
            a: m * (d.a ?? 1),
            b: f * (d.b ?? 1),
            c: -f * (d.c ?? 1),
            d: m * (d.d ?? 1)
        ...
        constructor(t) {
            this.container = t, this._applyPostDrawUpdaters = t => {
                ...
                for (const s of this._colorPlugins)
                    if (!e && s.particleFillColor && (e = It(s.particleFillColor(t))), !i && s.particleStrokeColor && (i = It(s.particleStrokeColor(t))), e && i) break;
                return [e, i]
            }, this._initCover = () => {
    ...
    class Ii {
        constructor() {
            this.angle = 90, this.count = 50, this.spread = 45, this.startVelocity = 45, this.decay = .9, this.gravity = 1, this.drift = 0, this.ticks = 200, this.position = {
                x: 50,
                y: 50
            }, this.colors = ["#26ccff", "#a25afd", "#ff5e7e", "#88ff5a", "#fcff42", "#ffa62d", "#ff36ff"], this.shapes = ["square", "circle"], this.scalar = 1, this.zIndex = 100, this.disableForReducedMotion = !0, this.flat = !1, this.shapeOptions = {}
        }
        get origin() {
            return {
        ...
        load(t) {
            ...
            const s = t.position;
            s && (void 0 !== s.x && (this.position.x = s.x), void 0 !== s.y && (this.position.y = s.y)), void 0 !== t.colors && (zt(t.colors) ? this.colors = [...t.colors] : this.colors = t.colors);
            ...
            void 0 !== t.shapes && (zt(t.shapes) ? this.shapes = [...t.shapes] : this.shapes = t.shapes), void 0 !== t.scalar && (this.scalar = t.scalar), void 0 !== t.zIndex && (this.zIndex = t.zIndex), void 0 !== t.disableForReducedMotion && (this.disableForReducedMotion = t.disableForReducedMotion)
        }
    }
                                ...
                                for (let t = 0, e = 0;;) {
                                    ...
                                    if (i = v(r, o), r += o + 1, i === m) {
                                        ...
                                        for (let s = 0; s < c[i].length; s++) {
                                            ...
                                            u.data.set([o, n, r, h], ms[l] * a.width + vs[l] * e + t % (4 * a.width)), t += 4
                                        }
                                        c.length === 1 << o && o < 12 && o++
                                    }
    ...
    async function ks(t, e = !0) {
        ...
        const i = new Ss(t);
        await t.addPlugin(i, e), await t.addShape(["image", "images"], new Cs(t), e)
    }
    class Ds extends Ie {
        constructor() {
            super(), this.sync = !1
    ...
    class As {
        draw(t) {
            const {
                ...
                particle: i,
                radius: s
            } = t, o = this.getCenter(i, s), n = this.getSidesData(i, s), a = n.count.numerator * n.count.denominator, r = n.count.numerator / n.count.denominator, c = 180 * (r - 2) / r, l = Math.PI - Math.PI * c / 180;
            if (e) {
    ...
    async function no(t) {
        if (!io) {
            ...
            so = !0, await async function (t, e = !0) {
                ...
                await t.addShape(["spade", "spades"], new Yi, e), await t.addShape(["heart", "hearts"], new Zi, e), await t.addShape(["diamond", "diamonds"], new Qi, e), await t.addShape(["club", "clubs"], new Ji, e)
            }(t, !1), await async function (t, e = !0) {
